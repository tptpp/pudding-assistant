...
fun ModelConfigScreen(
    ...
    android.util.Log.d("ModelConfigScreen", "Init: apiKey=${currentConfig.apiKey?.take(10)}..., baseUrl=${currentConfig.baseUrl}")

    // 当 currentConfig 变化时更新状态
    LaunchedEffect(currentConfig) {
        android.util.Log.d("ModelConfigScreen", "LaunchedEffect: apiKey=${currentConfig.apiKey?.take(10)}..., baseUrl=${currentConfig.baseUrl}")
